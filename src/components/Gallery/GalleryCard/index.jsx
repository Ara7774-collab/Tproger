export default function GalleryCard({ painting }) {
  return (
        ...
        <div className="art-card__info">
          ...
          <div className="art-card__content">
            <div className="art-card__text art-card__text--default">
              <p className="art-card__title">{painting.title}</p>
              <p className="art-card__year">{painting.year}</p>
            </div>
            <div className="art-card__text art-card__text--hover">
              <p className="art-card__author">{painting.artist}</p>
              <p className="art-card__museum">{painting.location}</p>
            </div>
          </div>
        </div>
